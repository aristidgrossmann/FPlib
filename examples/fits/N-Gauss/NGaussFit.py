...
############################   DATA LOADING   #######################
os.chdir('examples/fits/N-Gauss/data')
...
model = fp_library.N_gaussian_fit #name of the model function (supported: linear_fit, exponential_fit, inverse_exponential_fit, gaussian_fit, double_gaussian_fit)
...
popt_gauss, popt_std_gauss, pcorr = fp_library.general_curve_fit(xdata, ydata, xerr, yerr, model, p0, optimize_starting_guess,   # data and optimization settings
